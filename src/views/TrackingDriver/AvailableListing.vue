<template>
  <div class="d-flex">
   ...
   <div class="d-lg-flex align-items-center mb-4 gap-3">
    ...
    <!-- <base-paginate @onChangeAmountToShow="onChangeAmountToShow" @onChange="getData" :pages="meta.last_page" v-model="query.page"/> -->
  </BaseCard>
...
import {availableDriver}  from '@/api/driver'
...
const getData = async () =>{
    try {
        loading.value = true;
        const res = await availableDriver(query.value);
